...
# Serverless REST API with Aurora Serverless v2 - Flow A (TF-Generated Secrets)
...
module "api_lambda" {
  ...
  policy_statements = {
    ...
    rds_iam_auth = {
      ...
      resources = ["arn:aws:rds-db:*:*:dbuser:${module.data.cluster_resource_id}/${var.db_username}"]
    }
  }
