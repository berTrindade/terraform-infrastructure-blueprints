...
This document provides detailed code patterns, structure guidelines, and modern Terraform features. For high-level principles, see the [terraform-practices skill](../SKILL.md).
