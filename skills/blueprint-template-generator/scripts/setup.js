...
function checkDependencies() {
  ...
  const packageJsonPath = join(repoRoot, 'skills', 'blueprint-template-generator', 'package.json');
...
function checkDirectoryStructure() {
  const repoRoot = getRepoRoot();
  const requiredDirs = [
    join(repoRoot, 'skills', 'blueprint-template-generator', 'templates'),
    join(repoRoot, 'skills', 'blueprint-template-generator', 'scripts'),
    join(repoRoot, 'skills', 'blueprint-template-generator', '__tests__'),
...
function checkTemplates() {
  const repoRoot = getRepoRoot();
  const templatesDir = join(repoRoot, 'skills', 'blueprint-template-generator', 'templates');
