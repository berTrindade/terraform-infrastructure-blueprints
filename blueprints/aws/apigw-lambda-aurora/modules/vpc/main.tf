# modules/vpc/main.tf
# VPC module for Serverless REST API with Aurora Serverless v2
# Creates minimal VPC with private subnets for Lambda and Aurora
...
resource "aws_security_group" "aurora" {
  name        = "${var.security_group_prefix}-aurora"
...
# Aurora ingress rule (separate to avoid circular dependency)
