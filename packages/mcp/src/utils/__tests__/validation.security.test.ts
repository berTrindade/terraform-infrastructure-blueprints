...
describe("Path Validation Security", () => {
  ...
  describe("Path Traversal Prevention", () => {
    it("rejects ../ traversal attempts", () => {
      ...
      expect(() => validateFilePath("blueprints/aws/../../etc/passwd", workspaceRoot)).toThrow(SecurityError);
    ...
    it("rejects URL-encoded traversal (%2e%2e%2f)", () => {
      ...
      expect(() => validateFilePath("blueprints%2faws%2f%2e%2e%2f%2e%2e%2fetc%2fpasswd", workspaceRoot)).toThrow(SecurityError);
    });
  ...
  describe("Null Byte Injection", () => {
    it("rejects null bytes in paths", () => {
      ...
      expect(() => validateFilePath("blueprints\0/aws/file.txt", workspaceRoot)).toThrow(SecurityError);
  ...
  describe("Edge Cases", () => {
    ...
    it("handles mixed encoding attempts", () => {
      expect(() => validateFilePath("blueprints/aws/%2e%2e/etc/passwd", workspaceRoot)).toThrow(SecurityError);
  ...
  describe("Valid Paths", () => {
    it("accepts valid relative paths", () => {
      expect(() => validateFilePath("blueprints/aws/apigw-lambda-rds/README.md", workspaceRoot)).not.toThrow();
      expect(() => validateFilePath("blueprints/aws/apigw-lambda-rds/modules/data/main.tf", workspaceRoot)).not.toThrow();
      expect(() => validateFilePath("blueprints/aws/apigw-lambda-rds/environments/dev/main.tf", workspaceRoot)).not.toThrow();
    });

    it("accepts paths with hyphens and underscores", () => {
      expect(() => validateFilePath("blueprints/aws/test-blueprint/file_name.tf", workspaceRoot)).not.toThrow();
    });
  });
});
