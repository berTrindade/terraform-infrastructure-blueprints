...
description: Comprehensive blueprint best practices with priority levels. Includes catalog, decision trees, workflow guidance, and code patterns organized by priority (CRITICAL, HIGH, MEDIUM, LOW). Use when selecting blueprints, writing Terraform code, or making architectural decisions.
---

# Blueprint Best Practices

Complete reference for all blueprint best practices, organized by priority level. This skill consolidates catalog, guidance, and patterns to help AI assistants prioritize recommendations.
...
- [ ] Have I checked Skills for static content? (`blueprint-best-practices`)
...
- `blueprint-best-practices`: This consolidated skill (catalog, patterns, workflows)
