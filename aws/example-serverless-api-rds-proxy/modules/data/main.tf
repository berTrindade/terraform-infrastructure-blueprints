...
# RDS PostgreSQL + RDS Proxy module for Serverless REST API
# Creates RDS instance with connection pooling via RDS Proxy
...
resource "aws_iam_policy" "proxy" {
  ...
  description = "Allow RDS Proxy to read database credentials"
