...
output "db_metadata_secret_arn" {
  description = "ARN of the database metadata secret (connection info, no password)"
  value       = module.secrets.metadata_secret_arn
}

output "db_metadata_secret_name" {
  description = "Name of the database metadata secret"
  value       = module.secrets.metadata_secret_name
}

output "db_password_secret_arn" {
  description = "ARN of the RDS-managed password secret"
