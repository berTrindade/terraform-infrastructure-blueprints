...
run "full_deployment" {
  ...
  # Verify Aurora reader endpoint created
  assert {
    condition     = output.aurora_reader_endpoint != ""
    error_message = "Aurora reader endpoint should be created"
  }
