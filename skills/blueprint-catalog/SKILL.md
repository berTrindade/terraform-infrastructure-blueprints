...
description: Blueprint catalog with decision trees, cross-cloud equivalents, and blueprint structure. Use when selecting blueprints, comparing options, or understanding available infrastructure patterns.
---
...
- **blueprint-patterns**: Common patterns used in blueprints (ephemeral passwords, VPC, etc.)
