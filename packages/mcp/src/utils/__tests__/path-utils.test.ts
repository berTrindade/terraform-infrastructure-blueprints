...
describe("Path Utils", () => {
  describe("resolveWorkspacePath", () => {
    ...
    it("resolves valid relative paths", () => {
      const result = resolveWorkspacePath("blueprints/aws/test/README.md", workspaceRoot);
      expect(result).toBe(path.join(workspaceRoot, "blueprints/aws/test/README.md"));
    });
    ...
    it("normalizes path separators", () => {
      const result = resolveWorkspacePath("blueprints\\aws\\test\\README.md", workspaceRoot);
      expect(result).toContain("blueprints");
