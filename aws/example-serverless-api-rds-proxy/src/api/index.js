/**
 * REST API CRUD Handler for Serverless API with RDS Proxy
 * 
 * This handler connects to PostgreSQL through RDS Proxy, which provides:
 * - Connection pooling (reduced cold start impact)
 * - Automatic connection management
 * - Better scalability for Lambda workloads
 * 
 * Endpoints:
...
const DB_HOST = process.env.DB_HOST; // This is the RDS Proxy endpoint
...
/**
 * Create a database connection (via RDS Proxy)
 * RDS Proxy handles connection pooling, so we can create connections freely
 */
